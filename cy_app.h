...
/**
 * @brief Check whether the application layer is ready to allow device to enter
 * Deep Sleep. This API also configures the various modules in the application
 * layer to go into Deep Sleep if entry into Deep Sleep is possible.
 * @return true if Deep Sleep entry is possible; false otherwise.
 */
bool Cy_App_Sleep (void);

/**
 * @brief Restore the application layer state after PMG device wakes from Deep Sleep
 * @return None
 */
 ...
 *
 * @return True if VConn was turned ON; false otherwise.
 */
